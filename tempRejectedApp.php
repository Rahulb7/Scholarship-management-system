							...
							<!-- Content -->
								<div class="content">
									<section>
										...
										<header>
											<h3><strong>Release for Accepted Students</strong></h3>
										</header>
			                            ...
			                            <table class="table table-bordered">
			                              ...
			                              A.status,A.verifiedBySignatory from application AS A join scholarship AS S ON A.scholarshipID=S.scholarshipID WHERE A.verifiedBySignatory='Rejected'";
